...
@RestController
@RequestMapping("/phase1.5/inventory5")
public class InventoryController5 {
    private final ServiceInventory5 sevice;

    public InventoryController5(ServiceInventory5 sevice) {
        this.sevice = sevice;
    }
